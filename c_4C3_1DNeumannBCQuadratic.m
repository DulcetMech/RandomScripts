...
% Example 4C.3
%
% Solve a 1D Acoustic cavity excited by a piston at one and closed at 
% the other end.
% Atalla
% Use of three-noded 1D finite element
%
%==================================================================
...
neta_a= input(' loss factor (damping) in the fluid: '); % Play withthis parameter
...
for n=1:length(omega)
    w=omega(n);
    R(ndof) = w^2*rho0*c0^2*(1+1i*neta_a); % Piston (fixeddisplacement) at x=L
